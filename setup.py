...
.. moduleauthor:: Jev Kuznetsov <jev.kuznetsov@gmail.com>
"""
...
setup(
    name='chopit',
    description="Static site builder based on JINJA2 templates and markdown",
    ...
    url= 'https://github.com/sjev/chopit',
    download_url=(
        f'https://github.com/sjev/'
        f'chopit/archive/{version}.tar.gz'
    ),
    keywords=[
